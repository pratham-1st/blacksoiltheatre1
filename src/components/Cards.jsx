  ...
  return (
    <div className='h-52 md:h-96 w-full flex '>
      ...
      {/* Card 2 */}
        ...
        <h1 className='text-[3vw] md:text-balance text-center font-bold text-white'>
              Watch us on YouTube!
        </h1>           
        <div className='flex gap-2 md:gap-5 mt-3 md:mt-5 items-center flex-col md:flex-row'>
          ...
          <button className='text-[3vw] md:text-[1.7vw] h-7 md:h-12 rounded-full font-bold text-white bg-red-500 px-2 pb-py-2 border-2'>
            Subscribe
          </button></a> 
        </div>
        </div>
