  ...
  return (
    ...
    <div className='h-[28vh] md:h-[70vh] w-full flex  bg-zinc-950'>
         <div className='h-full w-1/2 flex justify-center items-center'>
              <p className='text-[1.6vh] md:text-[2.1vw] text-white text-ellipsis  px-4 py-5 md:p-10 font-semibold'>
    ...
    <div className='h-full w-1/2 flex justify-center items-center'>
     <p className='text-[1.6vh] md:text-[2.1vw] text-white  p-4 md:p-10  md:mt-0 font-semibold'>
