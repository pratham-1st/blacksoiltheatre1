  ...
  return (
    ...
    <div className='h-[28vh] md:h-[70vh] w-full flex  bg-zinc-950'>
         <div className='h-full w-1/2'>
              <p className='text-[2.9vw] md:text-[2.1vw] text-white text-ellipsis flex justify-center items-center px-4 py-5 md:p-10 font-semibold'>
    ...
    <div className='h-full w-1/2 '>
     <p className='text-[2.9vw] md:text-[2.1vw] text-white flex justify-center items-center p-4 md:p-10  md:mt-0 font-semibold'>
